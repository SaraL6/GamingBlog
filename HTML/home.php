            ...
            <?php   while ($ligne=$resultat2->fetch()) { ?>
                <div class="col-md-4">
                    ...
                    <div class="intro-text-box text-box text-white">
                        ...
                        <div class="top-meta"><?php  echo  $ligne["date_creation"] ?>/ in <a href=""><?php  echo  $ligne["intitule_categorie"] ?></a></div>
                        <h3><?php  echo  $ligne["titre"] ?></h3>
                        <p>
                        <?php  echo  $ligne["descriptionn"] ?>
                        </p>
                        <a href="game-single.php?id_article=<?php  echo  $ligne["id_article"] ?>" class="read-more">Read More <img src="img/icons/double-arrow.png" alt="#" /></a><br>
                        <br>
